class DocsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @doc.save
        format.html { redirect_to @doc, notice: 'PRD was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @doc.update(doc_params)
        format.html { redirect_to @doc, notice: 'PRD was successfully updated.' }
  ...
  def destroy
    @doc.destroy
    respond_to do |format|
      format.html { redirect_to docs_url, notice: 'PRD was successfully deleted.' }
